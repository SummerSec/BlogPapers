---
layout: default
title: "Basic query for Java code"
tags:
- blog-comments
- Java 反序列化
---
...
5. Click **Run**.
   ...
   ![image-20210319162604365](./pic/Basic-query-for-Java-code/4u26er4ec.png)

   ![image-20210319164221280](./pic/Basic-query-for-Java-code/21u42er21ec.png)
...
|  | 声明的形式是： <variable name <类型> <变量名>。 | 我们使用:一个 “IfStmt “变量用于 “if “语句; a “Block “变量用于 “then “块。 |
...
|  | 定义了每个匹配的报告内容。用于查找不良编码实践实例的查询的select语句总是采用这样的形式：select , ““ | 用一个解释问题的字符串报告结果的if语句。 |
