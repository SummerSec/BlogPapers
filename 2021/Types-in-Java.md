...
![image-20210324160901936](./pic/Types-in-Java/2u09er2ec.png)

![image-20210324161105048](./pic/Types-in-Java/5u11er5ec.png)
...
![image-20210324161149391](./pic/Types-in-Java/49u11er49ec.png)

![image-20210324161207361](./pic/Types-in-Java/7u12er7ec.png)
...
> 注意在CollectionToArrayCall的构造函数中使用了getSourceDeclaration和overridesOrInstantiates：我们要找到对Collection.toArray和任何覆盖它的方法的调用，以及这些方法的任何参数化实例。例如，在我们上面的例子中，调用l.toArray解析到原始类ArrayList中的方法toArray。它的源声明是通用类ArrayList中的toArray，它覆盖了AbstractCollection.toArray，而AbstractCollection.toArray又覆盖了Collection.toArray，它是Collection.toArray的一个实例化（因为覆盖方法中的类型参数T属于ArrayList，是属于Collection的类型参数的实例化）。
...
![image-20210324162027070](/.io//C:%5CUsers%5CSamny%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20210324162027070.png)

![image-20210324162036681](/.io//C:%5CUsers%5CSamny%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20210324162036681.png)
...
![image-20210324162120571](./pic/Types-in-Java/20u21er20ec.png)

![image-20210324162138891](./pic/Types-in-Java/38u21er38ec.png)

![image-20210324162156970](./pic/Types-in-Java/57u21er57ec.png)
...
> 最后，null是特殊的，因为它的类型（在CodeQL库中称为）与每个引用类型都是兼容的，所以我们应该把它排除在考虑范围之外。
...
![image-20210324164441442](./pic/Types-in-Java/41u44er41ec.png)
