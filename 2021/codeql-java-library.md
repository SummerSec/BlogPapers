...
- `PrimitiveType` represents a [primitive type](https://docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes.html), that is, one of `boolean`, `byte`, `char`, `double`, `float`, `int`, `long`, `short`; QL also classifies `void` and `<nulltype>` (the type of the `null` literal) as primitive types.
  ...
  > PrimitiveType表示一个基元类型，即布尔、字节、char、double、float、int、long、short中的一种；QL还将void和（null文字的类型）归为基本类型。
...
![image-20210319172755510](./pic/CodeQL-library-for-Java/55u27er55ec.png)
...
![image-20210319172840606](./pic/CodeQL-library-for-Java/40u28er40ec.png)
...
![image-20210320173224433](./pic/CodeQL-library-for-Java/24u32er24ec.png)
...
![image-20210320173428831](./pic/CodeQL-library-for-Java/28u34er28ec.png)
...
![image-20210403140840778](./pic/CodeQL-library-for-Java/40u08er40ec.png)

![image-20210403140900760](./pic/CodeQL-library-for-Java/0u09er0ec.png)

![image-20210403140909188](./pic/CodeQL-library-for-Java/9u09er9ec.png)
...
![image-20210403140742484](./pic/CodeQL-library-for-Java/42u07er42ec.png)

![image-20210403140759377](./pic/CodeQL-library-for-Java/59u07er59ec.png)

![image-20210403140817058](./pic/CodeQL-library-for-Java/17u08er17ec.png)
...
![image-20210403140957983](./pic/CodeQL-library-for-Java/58u09er58ec.png)

![image-20210403141011087](./pic/CodeQL-library-for-Java/11u10er11ec.png)
...
![image-20210403141127739](./pic/CodeQL-library-for-Java/27u11er27ec.png)

![image-20210403141143544](./pic/CodeQL-library-for-Java/43u11er43ec.png)
...
![image-20210403141206903](./pic/CodeQL-library-for-Java/23u12er23ec.png)

![image-20210403141218104](./pic/CodeQL-library-for-Java/20u12er20ec.png)
...
![image-20210403141254733](./pic/CodeQL-library-for-Java/54u12er54ec.png)

![image-20210403141306146](./pic/CodeQL-library-for-Java/6u13er6ec.png)

![image-20210403141313866](./pic/CodeQL-library-for-Java/13u13er13ec.png)
...
![image-20210403141336606](./pic/CodeQL-library-for-Java/36u13er36ec.png)

![image-20210403141348167](./pic/CodeQL-library-for-Java/48u13er48ec.png)

![image-20210403141356069](./pic/CodeQL-library-for-Java/56u13er56ec.png)
...
![image-20210403141421800](./pic/CodeQL-library-for-Java/21u14er21ec.png)

![image-20210403141431722](./pic/CodeQL-library-for-Java/31u14er31ec.png)
...
![image-20210403141526423](./pic/CodeQL-library-for-Java/26u15er26ec.png)

![image-20210403141546581](./pic/CodeQL-library-for-Java/46u15er46ec.png)

![](./pic/CodeQL-library-for-Java/38u15er38ec.png)
...
![image-20210403141611245](./pic/CodeQL-library-for-Java/11u16er11ec.png)

![image-20210403141623796](./pic/CodeQL-library-for-Java/23u16er23ec.png)
...
![image-20210403141639213](./pic/CodeQL-library-for-Java/39u16er39ec.png)

![image-20210403141650173](./pic/CodeQL-library-for-Java/57u16er57ec.png)

![image-20210403141657082](./pic/CodeQL-library-for-Java/57u16er57ec.png)
