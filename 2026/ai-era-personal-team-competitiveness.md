...
以前接到任务，我们习惯先按人的能力分工、排流程，再想需要什么工具。现在更合适的起点是：这件事里 AI 能做什么？它需要哪些上下文？又该给它留下哪些观察、执行和验证的入口？

如果流程还是旧流程，只是让 AI 写几段代码、生成一份内容，它就只是外挂。过去的经验也不是不能用，只是不能再当默认答案。模型能力、工具形态和协作方式都在变，原来的分工和判断得重新过一遍。
