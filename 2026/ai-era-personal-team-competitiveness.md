...
我们另外一个做得不好的地方，是明明外部条件已经变了，仍然围着过去的成功经验继续优化。旧产品做了几年，流程跑过很多次，团队也投入了不少人力，于是大家很自然地觉得：既然已经花了这么多，再改一改总比推倒重来便宜。

这里最容易算错账。已经投入的钱、时间和代码都不会因为继续投入而回来。做下一步决策时，真正该比较的是两条路从现在开始还要付出什么、最后可能得到什么，而不是过去分别花了多少。沉没成本当然在账上存在，但它不该替未来投票。

AI 会让这种误判变得更贵。一个半年前合理的技术方案，可能是建立在模型能力不足、生成成本太高或者工具链不成熟的条件上。条件一变，原来的架构和流程就可能失去存在的理由。此时继续打补丁，单次看起来很省，累计下来却比重写更慢，也把团队困在上一代方法里。

不是所有旧东西都要扔掉。核心假设仍然成立，产品也持续解决真实问题，就继续迭代；如果核心假设已经消失，新的实现方式又明显更简单，就该认真考虑重构甚至重写。产品方向错了，就停。管理方式开始阻碍 AI 协作，就换。成功经验能证明它在过去的环境里有效，不能证明它今天仍是答案。

从头开始也有迁移、验证和稳定性成本，不能为了追新而追新。问题在于，我们常常只要求新方案证明自己，却默认旧方案可以无限续期。更公平的做法是让两边接受同样的检验：谁能更快、更稳、更低成本地解决现在的问题，就选谁。

这件事管理者得管。除了复用经验，还要定期检查经验赖以成立的条件。该替换就替换，该停就停，也要允许团队删除已经失效的流程、文档和产品。只进不出的知识库，最后装的未必全是资产，也可能是一堆没人敢动的历史包袱。
...
AI 不会真的把所有人放到完全相同的起跑线上。行业知识、用户关系、数据和工程判断仍然有价值。但过去的经验即使让你领先过，也不能保证以后还能照原样复用。别人追上来通常只是时间问题，而 AI 正在把这段时间压得越来越短。过去需要几年积累的能力，现在可能几个月甚至几周就能补上。

最危险的不是别人追赶，而是把过去的领先误认为长期优势，待在自己熟悉的方法、流程和产品里反复优化。旧产品的代码更多，不代表它更接近未来；旧方法执行得更熟练，也不代表它仍然值得执行。

真正能拉开差距的，是愿不愿意重新判断，敢不敢承认原来的路已经走不通，然后尽快做出下一次验证。有时只需要更新方法，有时得拆掉旧的分工、流程和产品假设，把仍然有效的部分重新组合。这个过程会否定自己过去的一部分工作，也会让人不舒服，但总比守着正在贬值的优势更好。

勇敢不是把一切推倒，果断也不是凭感觉豪赌。先用小实验拿证据，证据表明该换路时，就别再躲进过去的版本和成功经验里。所谓打破自己，不是把积累全部清零，而是不再让积累决定自己只能往哪里走。
