...
我在《[模型人人都能用，什么才是你能带走的？我的答案是一个可进化的SKILL库](./why-personal-agent-skills-repo.md)》里写过自己的做法：用 GitHub 和 Git 管理不同类型的插件，保留多个版本，需要什么就启用什么。核心 `SKILL.md` 只维护一份，外面再做不同平台的适配。换设备、换 Agent、换项目，这套经验还能跟着我走。
