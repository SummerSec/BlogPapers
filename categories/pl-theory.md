...
<div class="category-page" data-topic="violet">
  <nav class="category-breadcrumb" aria-label="页面路径"><a href="./README.html">主题分类</a><span aria-hidden="true">/</span><span aria-current="page">程序分析理论</span></nav>
  <header class="category-page__header">
    <p class="category-page__code">PL</p>
    <h1>程序分析理论</h1>
    <p class="category-page__description">数据流分析、过程间分析与程序分析基础理论。</p>
    <div class="category-page__count"><strong>6</strong> 篇文章</div>
  </header>
